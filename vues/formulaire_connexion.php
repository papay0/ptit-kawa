                    ...
                    <div class="w-section inverse">
                        <div class="w-box sign-in-wr bg-5">
                            ...
                            <div class="alert alert-danger fade in">
                              ...
                              <strong>Information :</strong> Pour les PPAs et nouveaux entrants: Normalement vous pouvez vous connecter avec votre compte INSA. Je verrai bien si ça marche ou pas!
                            </div>
                            <div class="form-body">
                                ...
                                <form action="index.php?page=login" style="margin-left: 5%; width: 90%;" role="form"  method="post" accept-charset="utf-8">
                                    ...
                                    <div class="form-group required">
                                        <label>Nom d'utilisateur (INSA ou Amicale)</label>
