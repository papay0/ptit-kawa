            ...
            $('a.zoombox').zoombox(
                {
                  ...
                  animation   : false,
                  duration : 25
                  //available themes : zoombox,lightbox, prettyphoto, darkprettyphoto, simple
                }
                    ...
                    <div class="w-section inverse">
                        <div class="container">
                          ...
                          <!-- <div class="alert alert-danger fade in"> -->
                            ...
                            <!--<strong>Information :</strong> C'est très lent à cause d'un problème de compression des photos, on va régler ça probablement demain. Sorry! -->
                          <!-- </div> -->
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="w-box">
                                                ...
                                                <div class="col-xs-6" >
                                                    <div  class="like-button">
                                                    <span class="button ">
                   <span class="ajax-refresh"><span data-image-id="<?php echo $topPhotoForVotes["id"][1]?>"><?php echo $topPhotoForVotes["min"][1][1]; ?></span></span> <a id="detailed" onClick="mettrePlusUn(<?php echo $topPhotoForVotes["id"][1];?>)" ><i class="fa   fa-heart"></i></a>
                                                    </span>
                                        ...
                                        <div class="w-box">
                                            ...
                                            <div class="col-xs-1">
                                                ...
                                                <div class="col-xs-6" >
                                                    <div  class="like-button">
                                                        <span class="button ">
                                   <span class="ajax-refresh"><span data-image-id="<?php echo $topPhotoForVotes["id"][2]?>"><?php echo $topPhotoForVotes["min"][2][2]; ?></span></span> <a id="detailed" onClick="mettrePlusUn(<?php echo $topPhotoForVotes["id"][2];?>)" ><i class="fa   fa-heart"></i></a>
                                                        </span>
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="w-box">
                                            ...
                                            <div class="col-xs-6" >
                                                <div  class="like-button">
                                                        <span class="button ">
                                   <span class="ajax-refresh"><span data-image-id="<?php echo $topPhotoForVotes["id"][3]?>"><?php echo $topPhotoForVotes["min"][3][3]; ?></span></span> <a id="detailed" onClick="mettrePlusUn(<?php echo $topPhotoForVotes["id"][3];?>)" ><i class="fa   fa-heart"></i></a>
                                                        </span>
